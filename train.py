...
all_words = sorted(set(all_words)) #Ordena y excluye repetidos
...
#Creation of Dataset with pytorch to automatically iterate over it and get batch training
